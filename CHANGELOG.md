...
- [#64](https://github.com/nathanvale/side-quest-word-on-the-street/pull/64) [`7c8d4ed`](https://github.com/nathanvale/side-quest-word-on-the-street/commit/7c8d4ed12e8d5642e06c06078b23bf9086ffa92c) Thanks [@nathanvale](https://github.com/nathanvale)! - Surface rate-limit diagnostics in Report schema and compact output
...
- [#55](https://github.com/nathanvale/side-quest-word-on-the-street/pull/55) [`1d9535b`](https://github.com/nathanvale/side-quest-word-on-the-street/commit/1d9535bd8bcb12e26f265ac7578f8c18f9b6c698) Thanks [@nathanvale](https://github.com/nathanvale)! - Rebrand from `@side-quest/last-30-days` to `@side-quest/word-on-the-street` (`wots`).

  - CLI command: `last-30-days` -> `wots`
  - Config dir: `~/.config/last-30-days/` -> `~/.config/wots/`
  - Cache dir: `~/.cache/last-30-days/` -> `~/.cache/wots/`
  - Data dir: `~/.local/share/last-30-days/` -> `~/.local/share/wots/`
  - Env vars: `LAST_30_DAYS_*` -> `WOTS_*`
  - User-Agent: `last-30-days-skill/1.0` -> `wots/1.0`
  - Context file: `last-30-days.context.md` -> `wots.context.md`
  - Telemetry app: `last-30-days` -> `wots`
